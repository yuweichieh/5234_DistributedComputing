...
<body>
	<nav>
		<h1><a href="/MyShoes/index" style="text-decoration:none; font-size: 30px;"><img href="/MyShoes/index" src="${pageContext.request.contextPath}/images/logo_nobg.png"></a></h1>
